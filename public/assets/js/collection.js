...
if (arg === "value1") {
    ...
    <ul class="carousel__thumbnails">
        <li>
            <label for="slide-1"><img style = "width: fit-content;" src="./plain/12x18 Glossy/1.jpg" alt=""></label>
        </li>
        <li>
            <label for="slide-2"><img style = "width: fit-content;" src="./plain/12x18 Glossy/2.jpg" alt=""></label>
        </li>
        <li>
            <label for="slide-3"><img style = "width: fit-content;" src="./plain/12x18 Glossy/3.jpg" alt=""></label>
        </li>
        <li>
            <label for="slide-4"><img style = "width: fit-content;" src="./plain/12x18 Glossy/4.jpg" alt=""></label>
        </li>
        <li>
            <label for="slide-5"><img style = "width: fit-content;" src="./plain/12x18 Glossy/5.jpg" alt=""></label>
        </li>
        <li>
            <label for="slide-6"><img style = "width: fit-content;" src="./plain/12x18 Glossy/6.jpg" alt=""></label>
        </li>
        <li>
            <label for="slide-7"><img style = "width: fit-content;" src="./plain/12x18 Glossy/7.jpg" alt=""></label>
        </li>
        <li>
            <label for="slide-8"><img style = "width: fit-content;" src="./plain/12x18 Glossy/8.jpg" alt=""></label>
        </li>
        <li>
            <label for="slide-9"><img style = "width: fit-content;" src="./plain/12x18 Glossy/9.jpg" alt=""></label>
        </li>
        <li>
